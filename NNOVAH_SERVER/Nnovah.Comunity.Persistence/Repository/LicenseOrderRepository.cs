...
{
    public class LicenseOrderRepository : GenericRepository<LicenseOrder>, ILicenseOrderRepository
    {
        public LicenseOrderRepository(NnovahComunityDatabaseContext context) : base(context)
        {
        }
    }
}
